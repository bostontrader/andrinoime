...
public final class SettingsValues {
    ...
    public SettingsValues(final Context context, final SharedPreferences prefs, final Resources res,
        ...
        mIncludesOtherImesInLanguageSwitchList = Settings.ENABLE_SHOW_LANGUAGE_SWITCH_KEY_SETTINGS
                ? prefs.getBoolean(Settings.PREF_INCLUDE_OTHER_IMES_IN_LANGUAGE_SWITCH_LIST, false)star/
                //: true /star forcibly star/;
        /starmShowsLanguageSwitchKey = Settings.ENABLE_SHOW_LANGUAGE_SWITCH_KEY_SETTINGS
                //? Settings.readShowsLanguageSwitchKey(prefs) : true /star forcibly star/;
...
/*    public boolean isApplicationSpecifiedCompletionsOn() {
    ...
    public boolean isLanguageSwitchKeyEnabled() {
        ...
        if (mIncludesOtherImesInLanguageSwitchList) {
            return imm.hasMultipleEnabledIMEsOrSubtypes(false /star include aux subtypes star/);
        } else {
