...
public class KeyboardView extends View {
    ...
    // Drawing
    /star* True if all keys should be drawn star/
    private boolean mInvalidateAllKeys;
    /star* The keys that should be drawn star/
    private final HashSet<Key> mInvalidatedKeys = new HashSet<>();
    /star* The working rectangle variable star/
    private final Rect mWorkingRect = new Rect();
    /star* The keyboard bitmap buffer for faster updates star/
    /star* The clip region to draw keys star/
    private final Region mClipRegion = new Region();
    private Bitmap mOffscreenBuffer;
    /star* The canvas for the above mutable keyboard bitmap star/
    private final Canvas mOffscreenCanvas = new Canvas();
    private final Paint mPaint = new Paint();
    private final Paint.FontMetrics mFontMetrics = new Paint.FontMetrics();*/
    public KeyboardView(final Context context, final AttributeSet attrs) {
        //this(context, attrs, R.attr.keyboardViewStyle); // original
