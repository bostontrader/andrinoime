...
public class Key implements Comparable<Key> {
    ...
    /star* Icon to display instead of a label. Icon takes precedence over a label star/
    private final int mIconId;

    /star* Width of the key, not including the gap star/
    private final int mWidth;
    /star* Height of the key, not including the gap star/
    ...
    /star* More keys column number and flags star/
    ...
    /star* Background type that represents different key background visual than normal one. star/
    ...
    private static final class OptionalAttributes {
        /star* Text to output when pressed. This can be multiple characters, like ".com" star/
        public final String mOutputText;
        public final int mAltCode;
        /star* Icon for disabled state star/
        public final int mDisabledIconId;
        /star* The visual insets star/
    ...
    /star* The current pressed state of this key star/
    private boolean mPressed;
    /star* Key is enabled and responds on press star/
    ...
    public static class Spacer extends Key {
        public Spacer(final TypedArray keyAttr, final KeyStyle keyStyle,
                      final KeyboardParams params, final KeyboardRow row) {
            super(null /star keySpec star/, keyAttr, keyStyle, params, row);
        }
        ...
        protected Spacer(final KeyboardParams params, final int x, final int y, final int width,
                         final int height) {
            super(null /star label star/, ICON_UNDEFINED, CODE_UNSPECIFIED, null /star outputText star/,
                    null /star hintLabel star/, 0 /star labelFlags star/, BACKGROUND_TYPE_EMPTY, x, y, width,
