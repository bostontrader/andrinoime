...
public class Keyboard {
    ...
    /star* Total height of the keyboard, including the padding and keys star/
    //public final int mOccupiedHeight;
    /star* Total width of the keyboard, including the padding and keys star/
    //public final int mOccupiedWidth;

    /star* Base height of the keyboard, used to calculate rows' height star/
    //public final int mBaseHeight;
    /star* Base width of the keyboard, used to calculate keys' width star/
    //public final int mBaseWidth;

    /star* The padding above the keyboard star/
    //public final int mTopPadding;
    /star* Default gap between rows star/
    //public final int mVerticalGap;

    /star* Per keyboard key visual parameters star/
    //public final KeyVisualAttributes mKeyVisualAttributes;

    //public final int mMostCommonKeyHeight;
    //public final int mMostCommonKeyWidth;

    /star* More keys keyboard template star/
