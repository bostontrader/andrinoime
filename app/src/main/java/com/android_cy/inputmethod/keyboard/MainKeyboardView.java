...
public final class MainKeyboardView extends KeyboardView /*implements PointerTracker.DrawingProxy,
    ...
    /** Listener for {@link KeyboardActionListener}. star/
    private KeyboardActionListener mKeyboardActionListener;

    /star Space key and its icon and background. star/
    ...
    public MainKeyboardView(final Context context, final AttributeSet attrs) {
        //this(context, attrs, R.attr.mainKeyboardViewStyle); // original
        this(context, attrs, 0); // tfr
    }
    ...
    public MainKeyboardView(final Context context, final AttributeSet attrs, final int defStyle) {
        ...
        PointerTracker.init(mainKeyboardViewAttr, mKeyTimerHandler, this /star DrawingProxy star/);
    ...
    public void dismissKeyPreviewWithoutDelay(final Key key) {
        mKeyPreviewChoreographer.dismissKeyPreview(key, false /star withAnimation star/);
    ...
    public void dismissKeyPreview(final Key key) {
        ...
        mKeyPreviewChoreographer.dismissKeyPreview(key, true /star withAnimation star/);
    }
    ...
    public void onLongPress(final PointerTracker tracker) {
        ...
        if (key.hasNoPanelAutoMoreKey()) {
            ...
            listener.onPressKey(moreKeyCode, 0 /star repeatCount star/, true /star isSinglePointer star/);
            listener.onCodeInput(moreKeyCode, Constants.NOT_A_COORDINATE,
                    Constants.NOT_A_COORDINATE, false /star isKeyRepeat star/);
            listener.onReleaseKey(moreKeyCode, false /star withSliding star/);
            return;
        }
        ...
        if (code == Constants.CODE_SPACE || code == Constants.CODE_LANGUAGE_SWITCH) {
            ...
            if (listener.onCustomRequest(Constants.CUSTOM_CODE_SHOW_INPUT_METHOD_PICKER)) {
                tracker.onLongPressed();
                listener.onReleaseKey(code, false /star withSliding star/);
                return;
            }
        }
    ...
    public void onShowMoreKeysPanel(final MoreKeysPanel panel) {
        ...
        dimEntireKeyboard(true /star dimmed star/);
    }
    ...
    public void onDismissMoreKeysPanel() {
        dimEntireKeyboard(false /star dimmed star/);
        if (isShowingMoreKeysPanel()) {
